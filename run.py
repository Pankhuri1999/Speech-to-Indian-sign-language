...
'voice', 'wednesday', 'weight']
        ...
        with sr.Microphone() as source:
                ...
                while True:
                        ...
                        print("To exit the application, please speak exit")
                        ...
                        try:
                                ...
                                if(a.lower()=='exit'):
                                    ...
                                    lbl = ImageLabel(root)
                                    lbl.pack()
                                    lbl.load(r'C:/Users/Pankhuri/speechToSign/dataset/{0}.gif'.format(a.lower()))
                                    root.mainloop()
                                else:
                               ...
                               print("Could not understand your words. Please speak again")
                        plt.close()
